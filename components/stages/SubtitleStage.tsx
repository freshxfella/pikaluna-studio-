    ...
    <section className="panel">
      <header className="panel__head">
        ...
        <p className="panel__blurb">
          Samodejno iz voiceoverja (Whisper). Transkribira govor iz Glasu, ti urediš vrstice in
          slog (font, efekt, animacija). Render izvede Montaža.
        </p>
      </header>

      <div className="btnrow">
        <button className="btn btn--sol" onClick={transcribe} disabled={busy}>
          {busy ? "Transkribiram …" : "Transkribiraj iz Glasu"}
        </button>
      ...
      <div className="subs-list">
        {lines.length === 0 && (
          <div className="vstatus" style={{ maxWidth: 920 }}>
            Ni vrstic. Transkribiraj iz Glasu ali dodaj vrstico ročno.
          </div>
        )}
        {lines.map((l, i) => (
